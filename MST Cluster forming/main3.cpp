...
bool prim(std::ostream& fout, vec_d& dst, std::vector<bool>& visited, vec_int& ancest,vec_pair_int& edges, DataPoints& data, vec_vec_pair_int_d& Graph, std::list<int>& open_nodes){
...
int main()
{
    ...
    while(!prim(fout, dst, visited, ancest, edges, data, Graph,open_nodes) && open_nodes.size()!=0);
