...
\section{Summary}
\vspace{5mm}
\par The CBM experiment should be able to recognize $\Phi$-meson decays to study the partonic matter. The simulations suggest that the detector will be capable of reconstructing these particles from the detected products.
