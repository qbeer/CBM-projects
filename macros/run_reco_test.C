...
void run_reco_test(Int_t nEvents = 1000,
              const char* setupName = "sis100_electron",
              const char* inputFile = "sim.root")
{
  ...
  TString inFile = "sim.root"; // give here or as argument; otherwise default is taken
  TString outDir  = "data/";
  TString outFile = "reco.root";  // Output file (reco)
