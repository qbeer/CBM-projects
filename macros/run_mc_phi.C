...
void run_mc_phi(TString inFile="Signal_phi_10.txt", const char* setupName = "sis100_electron", Int_t nEvents = 10)
{
  ...
  TString outFile = "sim_phi_10.root";
...
//  }//   FairAsciiGenerator *SignalGen = new FairAsciiGenerator(signalFile);
