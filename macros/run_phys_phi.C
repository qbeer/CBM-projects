...
void run_phys_phi(Int_t nEvents = 10, const char* setupName = "sis100_electron")
{
  TStopwatch timer;
  timer.Start();
  ...
  TString inFile  = "sim_phi_10.root";
  TString parFile = "param_phi_10.root";
  TString recFile = "reco_phi_10.root";
  TString outFile = "phys_phi_10.root";
...
//   TString outFile = "/d/cbm05/vassiliev/urqmd.nini.15gev.centr.02990.phys.root";
  TString effFile = "Efficiency_KFParticleFinder_phi_10.txt";
  TString histoFile = "KFParticleFinder_phi_10.root";
