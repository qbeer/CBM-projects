...
void run_mc_draw(TString inFile="/d/cbm05/vassiliev/urqmd.auau.10gev.centr.00001.root", const char* setupName = "sis100_electron", Int_t nEvents = 2)
{
  ...
  TString outFile = "sim_draw.root";
  TString parFile = "param_draw.root";
  TString geoFile = "geofile_draw.root";
  // --- Logger settings ----------------------------------------------------
